export default defineAppConfig({
  ui: {
    ...
    gray: "neutral",
    formGroup: {
      help: "text-base mt-1 text-gray-500 dark:text-gray-400",
      error: "text-base mt-1 text-red-500 dark:text-red-400",
      label: {
        base: " block font-medium text-gray-500 dark:text-gray-200",
      },
    },
    button: {
      rounded:
