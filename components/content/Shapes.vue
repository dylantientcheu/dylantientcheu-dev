  ...
  <div class="px-4 py-8 flex items-center justify-center flex-col">
    <div class="flex w-full items-center gap-4">
      <div class="flex flex-col items-center gap-3">
        ...
        <p class="text-base font-semibold text-gray-500">Triangle</p>
      </div>
      <div class="flex flex-col items-center gap-3">
        <div
        ...
        <p class="text-base font-semibold text-gray-500">Star</p>
      </div>
      <div class="flex flex-col items-center gap-3">
        <div class="w-0 h-0 border-x-[20px] border-x-transparent border-y-[25px] border-y-indigo-500"></div>
        <p class="text-base font-semibold text-gray-500">Hourglass</p>
      </div>
      <div class="flex flex-col items-center gap-3">
        <div class="w-20 h-12 bg-teal-500 -skew-x-[16deg]"></div>
        <p class="text-base font-semibold text-gray-500">Parallelogram</p>
      </div>
    </div>
  </div>
</template>
