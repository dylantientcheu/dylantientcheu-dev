<template>
  <div class="mx-auto lg:w-1/2">
    ...
    <p mt-8>
      You can find me on
      <a @mouseenter="popTech(['i-logos-github-icon'])" @mouseleave="unpopTech" class="cursivo" href="https://github.com/blurdylan">Github</a>,
      <a @mouseenter="popTech(['i-logos-linkedin-icon'])" @mouseleave="unpopTech" class="cursivo" href="https://www.linkedin.com/in/dylan-tientcheu/">LinkedIn</a>
      and
      <a @mouseenter="popTech(['i-logos-instagram-icon'])" @mouseleave="unpopTech" class="cursivo" href="https://www.instagram.com/dylantientcheu/">Instagram</a>.
    </p>
    ...
    <TransitionGroup v-if="projects" appear name="list" class="grid md:gap-2 md:grid-cols-2" tag="div">
      <a v-for="(project, index) in projects" :key="project.name" :href="project.url" target="_blank"
        class="font-normal no-underline">
        <Project @mouseenter="popTech(project.tools)" @mouseleave="unpopTech" :icon="project.icon" :name="project.name"
    ...
    <p mt-4>
      ...
      <a class="cursivo" href="https://blog.logrocket.com/author/dylan-tientcheu/">Logrocket</a>, <a class="cursivo" @mouseenter="popTech(['i-logos-medium-icon'])" @mouseleave="unpopTech"
        href="https://medium.com/@blurdylan">Medium</a> and
      <a class="cursivo" @mouseenter="popTech(['i-logos-twitter'])" @mouseleave="unpopTech" href="https://twitter.com/dylantientcheu">Twitter</a>.
    </p>
    ...
    <p mt-4>
      Hit me up at
      <a class="" @mouseenter="popTech(['i-logos-google-gmail'])" @mouseleave="unpopTech" href="mailto:hi@dylantientcheu.dev">hi@dylantientcheu.dev</a>
    </p>
  </div>
</template>
