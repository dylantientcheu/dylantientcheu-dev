...
onMounted(() => {
  const projectsList = [
    ...
    },
    {
      ...
      tools: ['i-logos-typescript-icon','i-logos-nodejs-icon', 'i-logos-firebase', 'i-logos-mocha', 'i-logos-chai'],
    },
    {
      name: 'Manifesto',
...
<template>
  <div class="mx-auto lg:w-1/2">
    <h1 class="font-black mt-4 mb-0 text-gray-400 text-3xl">
      <div><span class="text-gray ml-4 top-2 text-3xl z-10 cursivo"><span class="animate-pulse">></span> summary</span></div>
    </h1>
    ...
    <h1 class="font-black mt-12 mb-4 text-gray-400 text-3xl">
      <span class="text-gray ml-4 top-2 text-3xl z-10 cursivo"><span class="animate-pulse">></span> my_craft</span>
    </h1>
    ...
    <h1 class="font-black mt-12 mb-4 text-gray-400 text-3xl">
      <span class="text-gray ml-4 top-2 text-3xl z-10 cursivo"><span class="animate-pulse">></span> blog_and_memos</span>
    </h1>
    <p mt-4>
    ...
    <h1 class="font-black mt-12 mb-0 text-gray-400 text-3xl">
      <span class="text-gray ml-4 top-2 text-3xl z-10 cursivo"><span class="animate-pulse">></span> get_in_touch</span>
    </h1>
    <p mt-4>
      Hit me up at
